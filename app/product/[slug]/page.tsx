        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div className="md:py-8 ">
            ...
            <div className="mb-4">
                ...
                <span className="text-sm text-gray-500">Inclusive. Vat plus shipping</span>
            </div>
            ...
            <div className="flex gap-2.5">
                <AddToBag price_id={data.price_id} currency={"USD"} description={data.description} image={data.images[0]} name={data.name} price={data.price} key={data._id} />
